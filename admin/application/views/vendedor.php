      ...
      <div class="col-lg-8 col-md-12 col-sm-12">
          <section class="panel">
              ...
              <div class="panel-body">
                  <div class="form">
                      <form class="cmxform form-horizontal adminex-form" id="nueva_comunidad" name="formguardado" method="POST" action="<?php echo base_url() ?>index.php/registros/vendedor">
