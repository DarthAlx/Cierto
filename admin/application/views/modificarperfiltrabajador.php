        ...
        <ul class="nav nav-tabs">
          ...
          <section class="panel">
              ...
              <div class="panel-body" >
                  <div class="form">
                      <form class="cmxform form-horizontal adminex-form" id="nuevo_trabajador" name="formguardado" method="POST" action="<?php echo base_url() ?>index.php/modificar/trabajador/<?=$id?>">

                          <div class="form-group ">
                              <label for="direccion" class="control-label col-lg-2">Dirección *</label>
                              <div class="col-lg-10">
                                  <input class=" form-control" id="direccion" name="direccion" type="text" value="<?php echo $trabajador->direccion?>" required/>
                              </div>
                          </div>
                          <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                ...
                                <script type='text/javascript'>
                                    document.getElementById('comunidad').value = '<?php echo $trabajador->comunidad?>';
                                </script>
                              </div>
                          </div>
                          <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                  <input class=" form-control" id="municipio" name="municipio" type="text" value="<?php echo $trabajador->municipio?>" required/>
                              </div>
                          </div>
                          <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                ...
                                <script type='text/javascript'>
                                    document.getElementById('estado').value = '<?php echo $trabajador->estado?>';
                                </script>
                              </div>
                          </div>
                          ...
                          <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                  <input class=" form-control" id="telefonopersonal" name="telefonopersonal" type="tel" value="<?php echo $trabajador->telefonopersonal?>" required/>
                              </div>
                          </div>
                          <div class="form-group ">
                              <label for="telefonodecaseta" class="control-label col-lg-2">Teléfono de caseta</label>
                              <div class="col-lg-10">
                                  <input class=" form-control" id="telefonodecaseta" name="telefonodecaseta" type="tel" value="<?php echo $trabajador->telefonodecaseta?>"/>
                              </div>
                          </div>
                          ...
                          <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                  <input class=" form-control" id="correo" name="correo" type="email" value="<?php echo $trabajador->correo?>" required/>
                              </div>
                          </div>
                            <h4 >
                                Persona de Contacto
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                    <input class=" form-control" id="nombre_contacto" name="nombre_contacto" type="text" value="<?php echo $trabajador->nombre_contacto?>" required/>
                                </div>
                            </div>
                            <div class="form-group ">
                                <label for="relacion" class="control-label col-lg-2">Relación *</label>
                                <div class="col-lg-10">
                                    <input class=" form-control" id="relacion" name="relacion" type="text" value="<?php echo $trabajador->relacion?>" required/>
                                </div>
                            </div>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                    <input class=" form-control" id="telefonocontacto" name="telefonocontacto" type="tel" value="<?php echo $trabajador->telefonocontacto?>" required/>
                                </div>
                            </div>
