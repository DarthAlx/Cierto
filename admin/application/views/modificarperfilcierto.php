        ...
        <ul class="nav nav-tabs">
          ...
          <section class="panel">
              ...
              <div class="panel-body">
                  <div class="form">
                      <form class="cmxform form-horizontal adminex-form" id="integrante" method="POST" name="formguardado" action="<?php echo base_url() ?>index.php/modificar/cierto/<?=$id?>">


                          <div class="form-group ">
                              <label for="perfil" class="control-label col-lg-2">Perfil *</label>
                              <div class="col-lg-10">
                                  <input class=" form-control" id="perfil" name="perfil" type="text" value="<?php echo $integrante->perfil?>" required/>
                              </div>
                          </div>
                          <div class="form-group ">
                              <label for="direccion" class="control-label col-lg-2">Dirección *</label>
                              <div class="col-lg-10">
                                  <input class=" form-control" id="direccion" name="direccion" type="text" value="<?php echo $integrante->direccion?>" required/>
                              </div>
                          </div>
                          <div class="form-group ">
                              <label for="municipio" class="control-label col-lg-2">Municipio *</label>
                              <div class="col-lg-10">
                                  <input class=" form-control" id="municipio" name="municipio" type="text" value="<?php echo $integrante->municipio?>" required/>
                              </div>
                          </div>
                          <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                ...
                                <script type='text/javascript'>
                                    document.getElementById('estado').value = '<?php echo $integrante->estado?>';
                                </script>
                              </div>
                          </div>
                          <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                ...
                                <script type='text/javascript'>
                                    document.getElementById('pais').value = '<?php echo $integrante->pais?>';
                                </script>
                              </div>
                          </div>
                          <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                  <input class="form-control" id="cp" name="cp" type="text" value="<?php echo $integrante->cp?>" required/>
                              </div>
                          </div>
                          ...
                          <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                  <input class=" form-control" id="telefono" name="telefono" type="tel" value="<?php echo $integrante->telefono?>" required/>
                              </div>
                          </div>
                          <div class="form-group ">
                              <label for="correo" class="control-label col-lg-2">Correo electrónico *</label>
                              <div class="col-lg-10">
                                  <input class=" form-control" id="correo" name="correo" type="email" value="<?php echo $integrante->correo?>" required/>
                              </div>
                          </div>
                            <div class="form-group ">
                                <label for="habilidades" class="control-label col-lg-2">Habilidades *</label>
                                <div class="col-lg-10">
                                    <textarea class=" form-control" id="habilidades" name="habilidades" value="" required><?php echo $integrante->habilidades?></textarea>
                                </div>
                            </div>
