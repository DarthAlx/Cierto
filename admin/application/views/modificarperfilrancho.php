<div class="wrapper">
  <?php if($exito){
    echo "<div class='alert alert-success alert-dismissible' role='alert'><button type='button' class='close' data-dismiss='alert' aria-label='Cerrar'><span aria-hidden='true'>&times;</span></button>Rancho actualizado exitosamente!</div>";
 }
        ...
        <ul class="nav nav-tabs">
          ...
          <section class="panel">
              ...
              <div class="panel-body" >
                  <div class="form">
                      <form class="cmxform form-horizontal adminex-form" id="nuevo_rancho" name="formguardado" method="POST" action="<?php echo base_url() ?>index.php/modificar/rancho/<?=$id?>">
                          ...
                          <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                  <input class=" form-control" id="direccion" name="direccion" type="text" value="<?php echo $rancho->direccion?>" required/>
                              </div>
                          </div>
                          <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                ...
                                <script type='text/javascript'>
                                    document.getElementById('comunidad').value = '<?php echo $rancho->comunidad?>';
                                </script>
                              </div>
                          </div>
                          <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                  <input class=" form-control" id="municipio" name="municipio" type="text" value="<?php echo $rancho->municipio?>" required/>
                              </div>
                          </div>
                          <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                ...
                                <script type='text/javascript'>
                                    document.getElementById('estado').value = '<?php echo $rancho->estado?>';
                                </script>
                              </div>
                          </div>
                          <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                ...
                                <script type='text/javascript'>
                                    document.getElementById('pais').value = '<?php echo $rancho->pais?>';
                                </script>
                              </div>
                          </div>
                          <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                  <input class="form-control" id="codigopostal" name="codigopostal" type="text" value="<?php echo $rancho->codigopostal?>" required/>
                              </div>
                          </div>
                          ...
                          <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                  <input class=" form-control" id="telefonoempresa" name="telefonoempresa" type="tel" value="<?php echo $rancho->telefonoempresa?>" required/>
                              </div>
                          </div>
                          <div class="form-group ">
                              <label for="correoelectronico" class="control-label col-lg-2">Correo electrónico *</label>
                              <div class="col-lg-10">
                                  <input class=" form-control" id="correoelectronico" name="correoelectronico" type="email" value="<?php echo $rancho->correoelectronico?>" required/>
                              </div>
                          </div>
                          <div class="form-group ">
                              <label for="paginaweb" class="control-label col-lg-2">Página web</label>
                              <div class="col-lg-10">
                                  <input class=" form-control" id="paginaweb" name="paginaweb" type="text"value="<?php echo $rancho->paginaweb?>" />
                              </div>
                          </div>
                          <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                ...
                                <script type='text/javascript'>
                                    document.getElementById('tipo').value = '<?php echo $rancho->tipo?>';
                                </script>
                              </div>
                          </div>
                          <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                  <input class=" form-control" id="numtrabajadores" name="numtrabajadores" type="number" value="<?php echo $rancho->numtrabajadores?>"/>
                              </div>
                          </div>
                          <h4 >
                              Persona de Contacto
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                    <input class=" form-control" id="nombrecontacto" name="nombrecontacto" type="text"value="<?php echo $rancho->nombrecontacto?>" required/>
                                </div>
                            </div>
                            <div class="form-group ">
                                <label for="cargo" class="control-label col-lg-2">Cargo *</label>
                                <div class="col-lg-10">
                                    <input class=" form-control" id="cargo" name="cargo" type="text" value="<?php echo $rancho->cargo?>" required/>
                                </div>
                            </div>
                            <div class="form-group ">
                                <label for="telefonocontacto" class="control-label col-lg-2">Teléfono *</label>
                                <div class="col-lg-10">
                                    <input class=" form-control" id="telefonocontacto" name="telefonocontacto" type="tel" value="<?php echo $rancho->telefonocontacto?>" required/>
                                </div>
                            </div>
